...
if_create_logo = BooleanVar()
if_create_logo.set(False)  # задайте проверку состояния чекбокса
if_create = Checkbutton(window, text='SALE NEW', var=if_create_logo)
if_create.grid(column=1, row=7)
...
if_price.grid(column=0, row=5)
valute.grid(column=1, row=5)
quantity_text.grid(column=0, row=6, padx=(10, 100))
quantity.grid(column=1, row=6, padx=(10, 100))
if_material.grid(column=1, row=7)
if_material_text.grid(column=0, row=7)
