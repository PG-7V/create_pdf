...
price_resize_text.grid(column=0, row=4, sticky=W, padx=10, pady=10)
price_resize.grid(column=1, row=4, sticky=W, padx=10, pady=10)
...
quantity.current(0)
quantity_text.grid(column=0, row=5, sticky=W, padx=10, pady=10)
quantity.grid(column=1, row=5, sticky=W, padx=10, pady=10)
...
if_material_text.grid(column=0, row=6, sticky=W, padx=10, pady=10)
if_material.grid(column=1, row=6, sticky=W, padx=10, pady=10)
...
if_create_logo_text.grid(column=0, row=7, sticky=W, padx=10, pady=10)
if_create_logo.grid(column=1, row=7, sticky=W, padx=10, pady=10)
...
if_characteristics_text.grid(column=0, row=8, sticky=W, padx=10, pady=10)
if_characteristics.grid(column=1, row=8, sticky=W, padx=10, pady=10)

# Отображать размеры

if_descr_size_text = Label(window, text='Отображать размеры')
if_descr_size = Combobox(window)
if_descr_size['value'] = ("Отобразить", "Скрыть")
if_descr_size.current(0)
if_descr_size_text.grid(column=0, row=9, sticky=W, padx=10, pady=10)
if_descr_size.grid(column=1, row=9, sticky=W, padx=10, pady=10)
